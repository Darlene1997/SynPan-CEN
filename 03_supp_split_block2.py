...
def get_block(ref, que, each_chr, ED, block_number, min_s_1, max_s_1,  min_s_2, max_s_2, Dir):
    ...
    block1_middle_1 = int((min_s_1 + max_s_1) / 4)  ### 取整
    block1_middle_2 = int((min_s_2 + max_s_2) / 4)
    block2_middle_1 = int((min_s_1 + max_s_1) / 2)
    block2_middle_2 = int((min_s_2 + max_s_2) / 2)
    block3_middle_1 = int(3 * (min_s_1 + max_s_1) / 4)
    block3_middle_2 = int(3 * (min_s_2 + max_s_2) / 4)

    os.system('echo "block_number: %s; middle 1: %s" >> %s_%s_%s_test.log' % (block_number, block1_middle_1, each_chr, ref, que))
    with open(in_re_format, 'r') as inf:
        with open(out_bigger_ED_1, 'w') as outf:
            for line in inf:  ## "chr_r", "id_r", "s_r", "e_r", "chr_q", "id_q", "s_q", "e_q", "prop", "ED"
                ...
                prop = text[8]
                ED_for_check = text[9]
                if (int(index_r) >= int(min_s_1)) and (int(index_r) <= int(block1_middle_1)) and (int(index_q) >= int(min_s_2)) and (int(index_q) <= int(block1_middle_2)) and (int(ED_for_check) <= int(ED)):
                    outf.write(str(chr_r) + "\t" + str(id_r) + "\t" + str(index_r) + "\t" + str(index_r) + "\t" + str(chr_q) + "\t" + str(id_q) + "\t" + str(index_q) + "\t" + str(index_q) + "\t" + str(prop) + "\n")


    os.system('echo "block_number: %s; middle 2: %s" >> %s_%s_%s_test.log' % (block_number, block1_middle_2, each_chr, ref, que))
    with open(in_re_format, 'r') as inf:
        with open(out_bigger_ED_2, 'w') as outf:
            for line in inf:  ## "chr_r", "id_r", "s_r", "e_r", "chr_q", "id_q", "s_q", "e_q", "prop", "ED"
                ...
                prop = text[8]
                ED_for_check = text[9]
                if (int(index_r) >= int(block1_middle_1)) and (int(index_r) <= int(block2_middle_1)) and (
                        int(index_q) >= int(block1_middle_2)) and (int(index_q) <= int(block2_middle_2)) and (
                        int(ED_for_check) <= int(ED)):
                    outf.write(str(chr_r) + "\t" + str(id_r) + "\t" + str(index_r) + "\t" + str(index_r) + "\t" + str(
                        chr_q) + "\t" + str(id_q) + "\t" + str(index_q) + "\t" + str(index_q) + "\t" + str(prop) + "\n")

    os.system('echo "block_number: %s; middle 3: %s" >> %s_%s_%s_test.log' % (block_number, block2_middle_1, each_chr, ref, que))
    with open(in_re_format, 'r') as inf:
        with open(out_bigger_ED_3, 'w') as outf:
            for line in inf:  ## "chr_r", "id_r", "s_r", "e_r", "chr_q", "id_q", "s_q", "e_q", "prop", "ED"
                text = line.strip().split("\t")
                chr_r = text[0]
                id_r = text[1]
                ...
                prop = text[8]
                ED_for_check = text[9]
                if (int(index_r) >= int(block2_middle_1)) and (int(index_r) <= int(block3_middle_1)) and (
                        int(index_q) >= int(block2_middle_2)) and (int(index_q) <= int(block3_middle_2)) and (
                        int(ED_for_check) <= int(ED)):
                    outf.write(
                        str(chr_r) + "\t" + str(id_r) + "\t" + str(index_r) + "\t" + str(index_r) + "\t" + str(
                            chr_q) + "\t" + str(id_q) + "\t" + str(index_q) + "\t" + str(index_q) + "\t" + str(
                            prop) + "\n")

    os.system('echo "block_number: %s; middle 4: %s" >> %s_%s_%s_test.log' % (block_number, block3_middle_2, each_chr, ref, que))
    with open(in_re_format, 'r') as inf:
        with open(out_bigger_ED_4, 'w') as outf:
            for line in inf:  ## "chr_r", "id_r", "s_r", "e_r", "chr_q", "id_q", "s_q", "e_q", "prop", "ED"
                text = line.strip().split("\t")
                chr_r = text[0]
                id_r = text[1]
                ...
                prop = text[8]
                ED_for_check = text[9]
                if (int(index_r) >= int(block3_middle_1)) and (int(index_r) <= int(max_s_1)) and (int(index_q) >= int(block3_middle_2)) and (int(index_q) <= int(max_s_2)) and (int(ED_for_check) <= int(ED)):
                    outf.write(str(chr_r) + "\t" + str(id_r) + "\t" + str(index_r) + "\t" + str(index_r) + "\t" + str(chr_q) + "\t" + str(id_q) + "\t" + str(index_q) + "\t" + str(index_q) + "\t" + str(prop) + "\n")
...
def get_DAGchainer_synteny(ref, que, each_chr, ED, block_number):
    ...
    out_bigger_ED_3 = str(each_chr) + "_" + str(ref) + "_" + str(que) + "_pairED" + str(ED) + "_block" + str(block_number) + "_3"
    DAG_block_file_3 = str(each_chr) + "_" + str(ref) + "_" + str(que) + "_pairED" + str(ED) + "_block" + str(block_number) + "_3.aligncoords"
    out_sg_3 = str(each_chr) + "_" + str(ref) + "_" + str(que) + "_pairED" + str(ED) + "_block" + str(block_number) + "_3.sg"
    out_bigger_ED_4 = str(each_chr) + "_" + str(ref) + "_" + str(que) + "_pairED" + str(ED) + "_block" + str(block_number) + "_4"
    DAG_block_file_4 = str(each_chr) + "_" + str(ref) + "_" + str(que) + "_pairED" + str(ED) + "_block" + str(block_number) + "_4.aligncoords"
    ...
    if os.path.exists(out_sg_1) and os.path.getsize(out_sg_1):
        ...
        if os.path.exists(DAG_block_file_1) and os.path.getsize(DAG_block_file_1):
            ...
            os.system("perl ./software/dagchainer/bin/run_DAG_chainer.pl -i %s -g 1 -D 20 -A 6 -Z 50 -e -3f" % (out_bigger_ED_1))
    ...
    if os.path.exists(out_sg_2) and os.path.getsize(out_sg_2):
        ...
        if os.path.exists(DAG_block_file_2) and os.path.getsize(DAG_block_file_2):
            ...
            os.system('echo "DAGchainer for block %s" >> %s_%s_%s_test.log' % (block_number, each_chr, ref, que))
            os.system("perl ./software/dagchainer/bin/run_DAG_chainer.pl -i %s -g 1 -D 20 -A 6 -Z 50 -e -3f" % (out_bigger_ED_2))  ## result file is "chr01_ref_que_group_pairED.aligncoords"
    ...
    ##########################  block3 ########################
    if os.path.exists(out_sg_3) and os.path.getsize(out_sg_3):
        pass
    else:
        if os.path.exists(DAG_block_file_3) and os.path.getsize(DAG_block_file_3):
            pass
        else:
            os.system('echo "DAGchainer for block %s" >> %s_%s_%s_test.log' % (block_number, each_chr, ref, que))
            os.system("perl ./software/dagchainer/bin/run_DAG_chainer.pl -i %s -g 1 -D 20 -A 6 -Z 50 -e -3f" % (out_bigger_ED_3))  ## result file is "chr01_ref_que_group_pairED.aligncoords"

    sz = os.path.getsize(DAG_block_file_3)
    if not sz:
        print(str(each_chr) + "_" + str(ref) + "_" + str(que) + "_pairED" + str(ED) + "_block" + str(block_number) + "_3.aligncoords --- It's empty!")
    else:
        os.system('echo "Start geting pairED%s_block%s_3.sg" >> %s_%s_%s_test.log' % (ED, block_number, each_chr, ref, que))
        add_each_block_without_overlap(ref, que, each_chr, ED, block_number)
        os.system('echo "Finish geting pairED%s_block%s_3.sg" >> %s_%s_%s_test.log' % (ED, block_number, each_chr, ref, que))

    ##########################  block4 ########################
    if os.path.exists(out_sg_4) and os.path.getsize(out_sg_4):
        pass
    else:
        if os.path.exists(DAG_block_file_4) and os.path.getsize(DAG_block_file_4):
            pass
        else:
            os.system('echo "DAGchainer for block %s" >> %s_%s_%s_test.log' % (block_number, each_chr, ref, que))
            os.system("perl ./software/dagchainer/bin/run_DAG_chainer.pl -i %s -g 1 -D 20 -A 6 -Z 50 -e -3f" % (out_bigger_ED_4))  ## result file is "chr01_ref_que_group_pairED.aligncoords"

    sz = os.path.getsize(DAG_block_file_4)
    if not sz:
        print(str(each_chr) + "_" + str(ref) + "_" + str(que) + "_pairED" + str(ED) + "_block" + str(block_number) + "_4.aligncoords --- It's empty!")
    else:
        os.system('echo "Start geting pairED%s_block%s_4.sg" >> %s_%s_%s_test.log' % (ED, block_number, each_chr, ref, que))
        add_each_block_without_overlap(ref, que, each_chr, ED, block_number)
        os.system('echo "Finish geting pairED%s_block%s_4.sg" >> %s_%s_%s_test.log' % (ED, block_number, each_chr, ref, que))
